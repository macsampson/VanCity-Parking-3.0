...
export default function Sidebar(props) {
        ...
        data.records.forEach((record) => {
          if (!newMeterInfo[record.fields.geom.coordinates]) {
            newMeterInfo[record.fields.geom.coordinates] = {
              ...
              sundays_holidays_early_rate: record.fields.r_su_9a_6p,
              sundays_holidays_early_limit: record.fields.t_su_9a_6p,
              sundays_holidays_late_rate: record.fields.r_su_6p_10,
              sundays_holidays_late_limit: record.fields.t_su_6p_10,
  ...
  function highlightMeterInfo(currentMeterId) {
    ...
    if (highlightedMeterInfo) {
      const highlightedMeterInfoElement =
        document.getElementById(highlightedMeterInfo);
